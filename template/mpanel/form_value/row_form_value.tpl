...
<td>
<nobr>
<A href="?action={$sBaseAction}_edit&id={$aRow.id}&id_form={$aRow.id_form}&id_item={$aRow.id_item}&return={$sReturn|escape:"url"}" onclick="
...
<nobr>
<A href="?action={$sBaseAction}_delete&id={$aRow.id}&id_form={$aRow.id_form}&id_item={$aRow.id_item}&return={$sReturn|escape:"url"}" onclick="if (confirm_delete_glg())
xajax_process_browse_url(this.href);  return false;">
