...
<tr>
 <th>
 	{$oLanguage->getDMessage('Set balance for:')}
...
<table cellspacing=2 cellpadding=1>
  <tr>
   ...
   <td><input type=text id="amount" name=data[amount] value="0" style="width: 50">
{*
...
<input type=hidden name=action value={$sBaseAction}_set_balance_apply>
</FORM>