...
<tr>
	<td width="100%">{$oLanguage->getDMessage('Page Keywords')}:</td>
...
<tr>
	<td width="100%">{$oLanguage->getDMessage('Without link')}:</td>
	<td>{include file='addon/mpanel/form_checkbox.tpl' sFieldName='only_childs' bChecked=$aData.only_childs}</td>
</tr>
