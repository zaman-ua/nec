...
<tr id="{$sIdiTr}{$iTr}" {if $bHideTr} pn="{$aItem[d].iHideTr}"{/if}
	...
	style="{if $aItem[d].hide_tr=='1'}display: none;{elseif $aItem[d].style_tr}{$aItem[d].style_tr}{elseif $aRow.order_status && $aOrderStatusBackgroundColor}background-color:{$aOrderStatusBackgroundColor[$aRow.order_status]}{/if}"
